...
//*# Library Name   : ts1n28hpcplvtb8192x64m8sw (user specify : TS1N28HPCPLVTB8192X64M8SW)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2020/06/24, 17:31:38										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB8192X64M8SW (
            CLK, CEB, WEB,
            A, D,
            BWEB,
            Q);
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB8192X64M8SW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB8192X64M8SW_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.5426;
    specparam tCKH = 0.0804;
    specparam tCKL = 0.0814;
    specparam tCS = 0.0759;
    specparam tCH = 0.0573;
    specparam tWS = 0.0424;
    specparam tWH = 0.0592;
    specparam tAS = 0.0556;
    specparam tAH = 0.0604;
    specparam tDS = 0.0322;
    specparam tDH = 0.0711;
    specparam tCD = 0.4857;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.4857;
`else    
    specparam tHOLD = 0.3787;
`endif    


    specparam tBWS = 0.0398;
    specparam tBWH = 0.0710;
