...
//*# Library Name   : ts5n28hpcplvta64x96m2fw (user specify : TS5N28HPCPLVTA64X96M2FW)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/07/14, 14:28:18										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS5N28HPCPLVTA64X96M2FW (
            CLK, CEB, WEB,
            A, D,
            BWEB,
            Q);
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA64X96M2FW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA64X96M2FW_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.1872;
    specparam tCKH = 0.0842;
    specparam tCKL = 0.0842;
    ...
    specparam tDS = 0.0124;
    specparam tDH = 0.0771;
    specparam tCD = 0.1439;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1439;
`else    
    specparam tHOLD = 0.0948;
`endif    


    specparam tBWS = 0.0117;
    specparam tBWH = 0.0771;
