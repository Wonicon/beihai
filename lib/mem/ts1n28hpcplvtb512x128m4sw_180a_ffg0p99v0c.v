...
//*# Library Name   : ts1n28hpcplvtb512x128m4sw (user specify : TS1N28HPCPLVTB512X128M4SW)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2020/06/24, 17:23:45										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB512X128M4SW (
            CLK, CEB, WEB,
            A, D,
            BWEB,
            Q);
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB512X128M4SW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB512X128M4SW_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.3589;
    specparam tCKH = 0.0629;
    specparam tCKL = 0.0888;
    specparam tCS = 0.0859;
    specparam tCH = 0.0306;
    specparam tWS = 0.0756;
    specparam tWH = 0.0324;
    specparam tAS = 0.0730;
    specparam tAH = 0.0335;
    specparam tDS = 0.0376;
    specparam tDH = 0.0872;
    specparam tCD = 0.2867;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2867;
`else    
    specparam tHOLD = 0.2136;
`endif    


    specparam tBWS = 0.0450;
    specparam tBWH = 0.0864;
    ...
    $setuphold(posedge CLK &&& check_write, negedge D[98], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[99], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[100], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[101], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[102], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[103], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[104], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[105], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[106], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[107], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[108], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[109], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[110], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[111], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[112], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[113], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[114], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[115], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[116], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[117], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[118], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[119], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[120], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[121], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[122], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[123], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[124], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[125], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[126], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, negedge D[127], tDS, tDH, notify_din);
    ...
    $setuphold(posedge CLK &&& check_write, posedge D[98], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[99], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[100], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[101], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[102], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[103], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[104], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[105], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[106], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[107], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[108], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[109], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[110], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[111], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[112], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[113], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[114], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[115], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[116], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[117], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[118], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[119], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[120], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[121], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[122], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[123], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[124], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[125], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[126], tDS, tDH, notify_din);
    $setuphold(posedge CLK &&& check_write, posedge D[127], tDS, tDH, notify_din);
    ...
    $setuphold(posedge CLK &&& check_write, negedge BWEB[98], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[99], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[100], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[101], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[102], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[103], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[104], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[105], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[106], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[107], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[108], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[109], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[110], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[111], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[112], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[113], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[114], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[115], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[116], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[117], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[118], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[119], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[120], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[121], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[122], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[123], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[124], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[125], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[126], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, negedge BWEB[127], tBWS, tBWH, notify_bweb);
    ...
    $setuphold(posedge CLK &&& check_write, posedge BWEB[98], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[99], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[100], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[101], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[102], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[103], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[104], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[105], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[106], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[107], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[108], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[109], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[110], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[111], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[112], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[113], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[114], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[115], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[116], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[117], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[118], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[119], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[120], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[121], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[122], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[123], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[124], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[125], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[126], tBWS, tBWH, notify_bweb);
    $setuphold(posedge CLK &&& check_write, posedge BWEB[127], tBWS, tBWH, notify_bweb);
...
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[98] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[98] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[98] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[98] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[98] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[98] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[99] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[99] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[99] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[99] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[99] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[99] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[100] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[100] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[100] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[100] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[100] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[100] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[101] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[101] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[101] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[101] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[101] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[101] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[102] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[102] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[102] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[102] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[102] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[102] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[103] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[103] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[103] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[103] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[103] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[103] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[104] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[104] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[104] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[104] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[104] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[104] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[105] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[105] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[105] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[105] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[105] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[105] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[106] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[106] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[106] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[106] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[106] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[106] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[107] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[107] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[107] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[107] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[107] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[107] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[108] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[108] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[108] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[108] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[108] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[108] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[109] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[109] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[109] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[109] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[109] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[109] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[110] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[110] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[110] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[110] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[110] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[110] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[111] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[111] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[111] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[111] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[111] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[111] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[112] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[112] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[112] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[112] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[112] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[112] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[113] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[113] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[113] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[113] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[113] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[113] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[114] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[114] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[114] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[114] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[114] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[114] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[115] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[115] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[115] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[115] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[115] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[115] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[116] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[116] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[116] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[116] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[116] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[116] high-Z during Sleep Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    if (SD_i === 1'b1 && DSLP_i === 1'b0 && SLP_i === 1'b0 && BWEB[117] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[117] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b1 && SLP_i === 1'b0 && BWEB[117] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB[117] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
`endif
`ifdef UNIT_DELAY
    #(SRAM_DELAY);
`endif
    ...
    else if (SD_i === 1'b0 && DSLP_i === 1'b0 && SLP_i === 1'b1 && BWEB[117] === 1'bz) begin
`ifdef no_warning
`else
        $display("\tWarning %m : input BWEB