...
//*# Library Name   : ts1n28hpcplvtb512x64m4sw (user specify : TS1N28HPCPLVTB512X64M4SW)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2020/07/06, 10:40:14										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB512X64M4SW (
            CLK, CEB, WEB,
            A, D,
            BWEB,
            Q);
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB512X64M4SW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB512X64M4SW_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.3043;
    specparam tCKH = 0.0628;
    specparam tCKL = 0.0886;
    ...
    specparam tDS = 0.0461;
    specparam tDH = 0.0605;
    specparam tCD = 0.2407;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2407;
`else    
    specparam tHOLD = 0.1881;
`endif    


    specparam tBWS = 0.0535;
    specparam tBWH = 0.0595;
