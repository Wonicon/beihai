...
//*# Library Name   : ts5n28hpcplvta64x88m2fw (user specify : TS5N28HPCPLVTA64X88M2FW)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/06/24, 17:34:26										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS5N28HPCPLVTA64X88M2FW (
            CLK, CEB, WEB,
            A, D,
            BWEB,
            Q);
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA64X88M2FW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA64X88M2FW_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.1860;
    specparam tCKH = 0.0837;
    specparam tCKL = 0.0837;
    ...
    specparam tDS = 0.0129;
    specparam tDH = 0.0761;
    specparam tCD = 0.1420;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1420;
`else    
    specparam tHOLD = 0.0940;
`endif    


    specparam tBWS = 0.0122;
    specparam tBWH = 0.0761;
