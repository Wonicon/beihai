...
//*# Library Name   : ts5n28hpcplvta64x100m2fw (user specify : TS5N28HPCPLVTA64X100M2FW)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/07/14, 14:28:08										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS5N28HPCPLVTA64X100M2FW (
            CLK, CEB, WEB,
            A, D,
            BWEB,
            Q);
...
parameter numRow = 32;
parameter numCM = 2;
parameter numIOBit = 100;
parameter numBit = 100;
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA64X100M2FW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA64X100M2FW_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.1878;
    specparam tCKH = 0.0845;
    specparam tCKL = 0.0845;
    ...
    specparam tDS = 0.0122;
    specparam tDH = 0.0776;
    specparam tCD = 0.1449;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1449;
`else    
    specparam tHOLD = 0.0951;
`endif    


    specparam tBWS = 0.0114;
    specparam tBWH = 0.0776;
