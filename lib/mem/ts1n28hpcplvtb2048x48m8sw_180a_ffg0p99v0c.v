...
//*# Library Name   : ts1n28hpcplvtb2048x48m8sw (user specify : TS1N28HPCPLVTB2048X48M8SW)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2020/06/24, 17:29:25										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB2048X48M8SW (
            CLK, CEB, WEB,
            A, D,
            BWEB,
            Q);
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB2048X48M8SW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB2048X48M8SW_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.4201;
    specparam tCKH = 0.0617;
    specparam tCKL = 0.0908;
    specparam tCS = 0.0878;
    specparam tCH = 0.0307;
    specparam tWS = 0.0445;
    specparam tWH = 0.0326;
    specparam tAS = 0.0694;
    specparam tAH = 0.0340;
    specparam tDS = 0.0568;
    specparam tDH = 0.0552;
    specparam tCD = 0.3353;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.3353;
`else    
    specparam tHOLD = 0.2621;
`endif    


    specparam tBWS = 0.0577;
    specparam tBWH = 0.0551;
