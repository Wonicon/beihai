...
//*                         : with d240 bit cell LVT periphery */
//*        Library Name     : ts6n28hpcplvta2048x32m8sw (user specify : TS6N28HPCPLVTA2048X32M8SW) */
//*        Library Version  : 130a */
//*        Generated Time   : 2020/06/28, 11:14:05 */
//*************************************************************************** ** */
`resetall
`celldefine
...
module TS6N28HPCPLVTA2048X32M8SW
  (AA,
  D,
  BWEB,
  WEB,CLKW,
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "TS6N28HPCPLVTA2048X32M8SW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "TS6N28HPCPLVTA2048X32M8SW_fault.cde";
`endif
...
$recrem (posedge CLKR, posedge CLKW &&& BbeforeA, trwcc, 0, valid_contention);
  ...
  $setuphold (posedge CLKW &&& WE, posedge AA[8], taas, taah, valid_aa);
  $setuphold (posedge CLKW &&& WE, negedge AA[8], taas, taah, valid_aa);
  $setuphold (posedge CLKR &&& RE, posedge AB[8], tabs, tabh, valid_ab);
  $setuphold (posedge CLKR &&& RE, negedge AB[8], tabs, tabh, valid_ab);
  $setuphold (posedge CLKW &&& WE, posedge AA[9], taas, taah, valid_aa);
  $setuphold (posedge CLKW &&& WE, negedge AA[9], taas, taah, valid_aa);
  $setuphold (posedge CLKR &&& RE, posedge AB[9], tabs, tabh, valid_ab);
  $setuphold (posedge CLKR &&& RE, negedge AB[9], tabs, tabh, valid_ab);
  $setuphold (posedge CLKW &&& WE, posedge AA[10], taas, taah, valid_aa);
  $setuphold (posedge CLKW &&& WE, negedge AA[10], taas, taah, valid_aa);
  $setuphold (posedge CLKR &&& RE, posedge AB[10], tabs, tabh, valid_ab);
  $setuphold (posedge CLKR &&& RE, negedge AB[10], tabs, tabh, valid_ab);

  $setuphold (posedge CLKW &&& WE, posedge D[0], tds, tdh, valid_d0);
  $setuphold (posedge CLKW &&& WE, negedge D[0], tds, tdh, valid_d0);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[0], tbws, tbwh, valid_bw0);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[0], tbws, tbwh, valid_bw0);
  $setuphold (posedge CLKW &&& WE, posedge D[1], tds, tdh, valid_d1);
  $setuphold (posedge CLKW &&& WE, negedge D[1], tds, tdh, valid_d1);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[1], tbws, tbwh, valid_bw1);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[1], tbws, tbwh, valid_bw1);
  $setuphold (posedge CLKW &&& WE, posedge D[2], tds, tdh, valid_d2);
  $setuphold (posedge CLKW &&& WE, negedge D[2], tds, tdh, valid_d2);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[2], tbws, tbwh, valid_bw2);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[2], tbws, tbwh, valid_bw2);
  $setuphold (posedge CLKW &&& WE, posedge D[3], tds, tdh, valid_d3);
  $setuphold (posedge CLKW &&& WE, negedge D[3], tds, tdh, valid_d3);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[3], tbws, tbwh, valid_bw3);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[3], tbws, tbwh, valid_bw3);
  $setuphold (posedge CLKW &&& WE, posedge D[4], tds, tdh, valid_d4);
  $setuphold (posedge CLKW &&& WE, negedge D[4], tds, tdh, valid_d4);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[4], tbws, tbwh, valid_bw4);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[4], tbws, tbwh, valid_bw4);
  $setuphold (posedge CLKW &&& WE, posedge D[5], tds, tdh, valid_d5);
  $setuphold (posedge CLKW &&& WE, negedge D[5], tds, tdh, valid_d5);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[5], tbws, tbwh, valid_bw5);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[5], tbws, tbwh, valid_bw5);
  $setuphold (posedge CLKW &&& WE, posedge D[6], tds, tdh, valid_d6);
  $setuphold (posedge CLKW &&& WE, negedge D[6], tds, tdh, valid_d6);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[6], tbws, tbwh, valid_bw6);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[6], tbws, tbwh, valid_bw6);
  $setuphold (posedge CLKW &&& WE, posedge D[7], tds, tdh, valid_d7);
  $setuphold (posedge CLKW &&& WE, negedge D[7], tds, tdh, valid_d7);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[7], tbws, tbwh, valid_bw7);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[7], tbws, tbwh, valid_bw7);
  $setuphold (posedge CLKW &&& WE, posedge D[8], tds, tdh, valid_d8);
  $setuphold (posedge CLKW &&& WE, negedge D[8], tds, tdh, valid_d8);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[8], tbws, tbwh, valid_bw8);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[8], tbws, tbwh, valid_bw8);
  $setuphold (posedge CLKW &&& WE, posedge D[9], tds, tdh, valid_d9);
  $setuphold (posedge CLKW &&& WE, negedge D[9], tds, tdh, valid_d9);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[9], tbws, tbwh, valid_bw9);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[9], tbws, tbwh, valid_bw9);
  $setuphold (posedge CLKW &&& WE, posedge D[10], tds, tdh, valid_d10);
  $setuphold (posedge CLKW &&& WE, negedge D[10], tds, tdh, valid_d10);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[10], tbws, tbwh, valid_bw10);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[10], tbws, tbwh, valid_bw10);
  $setuphold (posedge CLKW &&& WE, posedge D[11], tds, tdh, valid_d11);
  $setuphold (posedge CLKW &&& WE, negedge D[11], tds, tdh, valid_d11);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[11], tbws, tbwh, valid_bw11);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[11], tbws, tbwh, valid_bw11);
  $setuphold (posedge CLKW &&& WE, posedge D[12], tds, tdh, valid_d12);
  $setuphold (posedge CLKW &&& WE, negedge D[12], tds, tdh, valid_d12);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[12], tbws, tbwh, valid_bw12);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[12], tbws, tbwh, valid_bw12);
  $setuphold (posedge CLKW &&& WE, posedge D[13], tds, tdh, valid_d13);
  $setuphold (posedge CLKW &&& WE, negedge D[13], tds, tdh, valid_d13);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[13], tbws, tbwh, valid_bw13);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[13], tbws, tbwh, valid_bw13);
  $setuphold (posedge CLKW &&& WE, posedge D[14], tds, tdh, valid_d14);
  $setuphold (posedge CLKW &&& WE, negedge D[14], tds, tdh, valid_d14);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[14], tbws, tbwh, valid_bw14);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[14], tbws, tbwh, valid_bw14);
  $setuphold (posedge CLKW &&& WE, posedge D[15], tds, tdh, valid_d15);
  $setuphold (posedge CLKW &&& WE, negedge D[15], tds, tdh, valid_d15);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[15], tbws, tbwh, valid_bw15);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[15], tbws, tbwh, valid_bw15);
  $setuphold (posedge CLKW &&& WE, posedge D[16], tds, tdh, valid_d16);
  $setuphold (posedge CLKW &&& WE, negedge D[16], tds, tdh, valid_d16);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[16], tbws, tbwh, valid_bw16);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[16], tbws, tbwh, valid_bw16);
  $setuphold (posedge CLKW &&& WE, posedge D[17], tds, tdh, valid_d17);
  $setuphold (posedge CLKW &&& WE, negedge D[17], tds, tdh, valid_d17);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[17], tbws, tbwh, valid_bw17);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[17], tbws, tbwh, valid_bw17);
  $setuphold (posedge CLKW &&& WE, posedge D[18], tds, tdh, valid_d18);
  $setuphold (posedge CLKW &&& WE, negedge D[18], tds, tdh, valid_d18);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[18], tbws, tbwh, valid_bw18);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[18], tbws, tbwh, valid_bw18);
  $setuphold (posedge CLKW &&& WE, posedge D[19], tds, tdh, valid_d19);
  $setuphold (posedge CLKW &&& WE, negedge D[19], tds, tdh, valid_d19);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[19], tbws, tbwh, valid_bw19);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[19], tbws, tbwh, valid_bw19);
  $setuphold (posedge CLKW &&& WE, posedge D[20], tds, tdh, valid_d20);
  $setuphold (posedge CLKW &&& WE, negedge D[20], tds, tdh, valid_d20);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[20], tbws, tbwh, valid_bw20);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[20], tbws, tbwh, valid_bw20);
  $setuphold (posedge CLKW &&& WE, posedge D[21], tds, tdh, valid_d21);
  $setuphold (posedge CLKW &&& WE, negedge D[21], tds, tdh, valid_d21);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[21], tbws, tbwh, valid_bw21);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[21], tbws, tbwh, valid_bw21);
  $setuphold (posedge CLKW &&& WE, posedge D[22], tds, tdh, valid_d22);
  $setuphold (posedge CLKW &&& WE, negedge D[22], tds, tdh, valid_d22);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[22], tbws, tbwh, valid_bw22);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[22], tbws, tbwh, valid_bw22);
  $setuphold (posedge CLKW &&& WE, posedge D[23], tds, tdh, valid_d23);
  $setuphold (posedge CLKW &&& WE, negedge D[23], tds, tdh, valid_d23);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[23], tbws, tbwh, valid_bw23);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[23], tbws, tbwh, valid_bw23);
  $setuphold (posedge CLKW &&& WE, posedge D[24], tds, tdh, valid_d24);
  $setuphold (posedge CLKW &&& WE, negedge D[24], tds, tdh, valid_d24);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[24], tbws, tbwh, valid_bw24);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[24], tbws, tbwh, valid_bw24);
  $setuphold (posedge CLKW &&& WE, posedge D[25], tds, tdh, valid_d25);
  $setuphold (posedge CLKW &&& WE, negedge D[25], tds, tdh, valid_d25);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[25], tbws, tbwh, valid_bw25);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[25], tbws, tbwh, valid_bw25);
  $setuphold (posedge CLKW &&& WE, posedge D[26], tds, tdh, valid_d26);
  $setuphold (posedge CLKW &&& WE, negedge D[26], tds, tdh, valid_d26);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[26], tbws, tbwh, valid_bw26);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[26], tbws, tbwh, valid_bw26);
  $setuphold (posedge CLKW &&& WE, posedge D[27], tds, tdh, valid_d27);
  $setuphold (posedge CLKW &&& WE, negedge D[27], tds, tdh, valid_d27);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[27], tbws, tbwh, valid_bw27);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[27], tbws, tbwh, valid_bw27);
  $setuphold (posedge CLKW &&& WE, posedge D[28], tds, tdh, valid_d28);
  $setuphold (posedge CLKW &&& WE, negedge D[28], tds, tdh, valid_d28);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[28], tbws, tbwh, valid_bw28);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[28], tbws, tbwh, valid_bw28);
  $setuphold (posedge CLKW &&& WE, posedge D[29], tds, tdh, valid_d29);
  $setuphold (posedge CLKW &&& WE, negedge D[29], tds, tdh, valid_d29);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[29], tbws, tbwh, valid_bw29);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[29], tbws, tbwh, valid_bw29);
  $setuphold (posedge CLKW &&& WE, posedge D[30], tds, tdh, valid_d30);
  $setuphold (posedge CLKW &&& WE, negedge D[30], tds, tdh, valid_d30);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[30], tbws, tbwh, valid_bw30);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[30], tbws, tbwh, valid_bw30);
  $setuphold (posedge CLKW &&& WE, posedge D[31], tds, tdh, valid_d31);
  $setuphold (posedge CLKW &&& WE, negedge D[31], tds, tdh, valid_d31);
 
  $setuphold (posedge CLKW &&& WE, posedge BWEB[31], tbws, tbwh, valid_bw31);
  $setuphold (posedge CLKW &&& WE, negedge BWEB[31], tbws, tbwh, valid_bw31);
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or AA[7]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && AA[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[7] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or AB[7]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && AB[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[7] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or AA[8]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && AA[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[8] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or AB[8]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && AB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[8] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or AA[9]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && AA[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[9] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or AB[9]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && AB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[9] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or AA[10]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && AA[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[10] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or AB[10]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && AB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[10] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[0]) begin
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[1]) begin
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[2]) begin
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[3]) begin
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[4]) begin
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[5]) begin
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[6]) begin
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[7]) begin
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[8]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[8] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[9]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[9] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[10]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[10] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[11]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[11] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[11] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[12]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[12] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[12] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[13]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[13] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[13] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[14]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[14] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[14] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[15]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[15] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[15] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[16]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[16] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[16]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[16] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[17]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[17] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[17]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[17] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[18]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[18] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[18]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[18] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[19]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[19] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[19]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[19] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[20]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[20] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[20]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[20] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[21]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[21] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[21]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[21] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[22]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[22] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[22]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[22] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[23]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[23] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[23]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[23] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[24]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[24] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[24]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[24] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[25]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[25] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[25]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[25] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[26]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[26] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[26]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[26] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[27]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[27] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[27]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[27] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[28]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[28] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[28]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[28] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[29]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[29] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[29]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[29] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[30]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[30] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[30]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[30] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or BWEB[31]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && BWEB[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[31] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(bSLP or bDSLP or bSD or bCLKR or bCLKW or bREB or bWEB or D[31]) begin
  if (bSD === 1'b0 && bSLP === 1'b0 && (bCLKR === 1'b0 || bCLKR === 1'b1) && (bCLKW === 1'b0 || bCLKW === 1'b1) && bREB === 1'b1 && bWEB === 1'b1 && D[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[31] high-Z during Standby Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && AA[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[7] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && AB[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[7] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && AA[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[8] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && AB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[8] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && AA[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[9] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && AB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[9] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && AA[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[10] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && AB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[10] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[8] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[9] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[10] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[11] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[11] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[12] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[12] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[13] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[13] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[14] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[14] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[15] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[15] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[16] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[16] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[17] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[17] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[18] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[18] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[19] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[19] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[20] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[20] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[21] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[21] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[22] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[22] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[23] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[23] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[24] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[24] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[25] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[25] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[26] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[26] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[27] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[27] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[28] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[28] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[29] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[29] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[30] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[30] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[31] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(negedge bSLP or negedge bDSLP or negedge bSD) begin
  if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b0 && D[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[31] high-Z during Wake Up Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && AA[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[7] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && AA[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[7] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && AA[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && AB[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[7] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && AB[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[7] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && AB[7] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && AA[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[8] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && AA[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[8] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && AA[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && AB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[8] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && AB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[8] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && AB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && AA[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[9] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && AA[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[9] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && AA[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && AB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[9] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && AB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[9] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && AB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && AA[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[10] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && AA[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AA[10] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && AA[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && AB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[10] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && AB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input AB[10] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && AB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[8] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[8] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[8] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[9] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[9] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[9] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[10] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[10] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[10] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[11] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[11] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[11] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[11] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[11] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[12] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[12] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[12] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[12] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[12] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[13] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[13] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[13] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[13] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[13] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[14] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[14] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[14] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[14] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[14] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[15] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[15] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[15] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[15] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[15] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[16] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[16] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[16] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[16] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[16] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[17] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[17] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[17] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[17] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[17] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[18] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[18] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[18] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[18] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[18] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[19] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[19] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[19] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[19] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[19] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[20] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[20] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[20] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[20] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[20] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[21] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[21] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[21] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[21] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[21] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[22] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[22] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[22] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[22] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[22] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[23] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[23] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[23] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[23] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[23] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[24] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[24] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[24] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[24] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[24] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[25] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[25] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[25] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[25] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[25] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[26] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[26] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[26] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[26] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[26] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[27] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[27] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[27] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[27] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[27] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[28] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[28] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[28] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[28] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[28] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[29] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[29] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[29] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[29] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[29] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[30] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[30] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[30] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[30] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[30] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && BWEB[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[31] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && BWEB[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input BWEB[31] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && BWEB[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
always @(posedge bSLP or posedge bDSLP or posedge bSD) begin
  if (bSD === 1'b1 && bDSLP === 1'b0 && bSLP === 1'b0 && D[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[31] high-Z during Shut Down Mode, Core Unknown at %t.>>", $realtime);
    end
      AAL = {M{1'bx}};
      BWEBL = {N{1'b0}};
      DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b1 && bSLP === 1'b0 && D[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
      $display("\nWarning %m input D[31] high-Z during DSLP Mode, Core Unknown at %t.>>", $realtime);
    end
    AAL = {M{1'bx}};
    BWEBL = {N{1'b0}};
    DL = {N{1'bx}};
...
`endif
  ...
  else if (bSD === 1'b0 && bDSLP === 1'b0 && bSLP === 1'b1 && D[31] === 1'bz) begin
    if(MES_ALL=="ON" && $realtime != 0) 
    begin
...
TS6N28HPCPLVTA2048X32M8SW_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
*/
module TS6N28HPCPLVTA2048X32M8SW_Int_Array (D, BW, AW, EN, RDB, AR, Q);
